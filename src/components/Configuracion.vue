<template>
	  ...
	  <div class="user-info-section">
		...
		<div class="profile-card">
		  <div class="profile-avatar">
			...
			<input type="file" ref="imagenInput" @change="cambiarFoto" style="display: none;" accept="image/*" />
		  </div>
  ...
  .edit-photo-btn i {
  font-size: 46px;      /* Tamaño reducido del ícono */
}
  ...
  .profile-card, .options-container {
